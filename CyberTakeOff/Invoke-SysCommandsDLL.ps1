...
# Add-Type -TypeDefinition $DotnetCode -OutputType Library -OutputAssembly 'C:\Users\hfaka\Desktop\pentester Powershell\SysCommands.dll'
Add-Type -TypeDefinition $DotnetCode -OutputType ConsoleApplication -OutputAssembly 'C:\Users\hfaka\Desktop\pentester Powershell\SysCommands.exe'
